...
var GlobeKapsule = _interopDefault(require('globe.gl'));
...
var Globe = fromKapsule(GlobeKapsule, {
  ...
  'globeMaterial', 'pauseAnimation', 'resumeAnimation', 'pointOfView', 'scene', 'camera', 'renderer', 'controls', 'getCoords', 'toGeoCoords'],
